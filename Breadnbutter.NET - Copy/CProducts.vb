...
Friend Class CProducts
	...
	Sub Add(ByRef Item As CProductData, Optional ByRef Key As Object = Nothing)
	...
	Function Item(ByRef Index As Object) As CProductData
		
		Item = m_CProducts.Item(Index)
	...
	'Function NewEnum() As stdole.IUnknown
		'
		'NewEnum = m_CProducts.GetEnumerator
		'
	'End Function
	...
	Function GetEnumerator() As System.Collections.IEnumerator Implements System.Collections.IEnumerable.GetEnumerator
		...
		'GetEnumerator = m_CProducts.GetEnumerator
	End Function
End Class