...
<ProvideProperty("Index",GetType(AxMSComCtl2.AxDTPicker))> Public Class AxDTPickerArray
	...
	Public Shadows Event [CallbackKeyDown] (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_CallbackKeyDownEvent)
	...
	Public Shadows Event [KeyDownEvent] (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_KeyDownEvent)
	Public Shadows Event [KeyUpEvent] (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_KeyUpEvent)
	Public Shadows Event [KeyPressEvent] (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_KeyPressEvent)
	Public Shadows Event [MouseDownEvent] (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_MouseDownEvent)
	...
	Protected Overrides Sub HookUpControlEvents(ByVal o As Object)
		...
		If Not CallbackKeyDownEvent Is Nothing Then
			AddHandler ctl.CallbackKeyDown, New AxMSComCtl2.DDTPickerEvents_CallbackKeyDownEventHandler(AddressOf HandleCallbackKeyDown)
		End If
		...
		If Not KeyDownEventEvent Is Nothing Then
			AddHandler ctl.KeyDownEvent, New AxMSComCtl2.DDTPickerEvents_KeyDownEventHandler(AddressOf HandleKeyDownEvent)
		End If
		...
		If Not KeyPressEventEvent Is Nothing Then
			AddHandler ctl.KeyPressEvent, New AxMSComCtl2.DDTPickerEvents_KeyPressEventHandler(AddressOf HandleKeyPressEvent)
		End If
		If Not MouseDownEventEvent Is Nothing Then
			AddHandler ctl.MouseDownEvent, New AxMSComCtl2.DDTPickerEvents_MouseDownEventHandler(AddressOf HandleMouseDownEvent)
		End If
	...
	Private Sub HandleCallbackKeyDown (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_CallbackKeyDownEvent) 
	...
	Private Sub HandleKeyDownEvent (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_KeyDownEvent) 
	...
	Private Sub HandleKeyPressEvent (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_KeyPressEvent) 
		RaiseEvent [KeyPressEvent] (sender, e)
	End Sub

	Private Sub HandleMouseDownEvent (ByVal sender As System.Object, ByVal e As AxMSComCtl2.DDTPickerEvents_MouseDownEvent) 
