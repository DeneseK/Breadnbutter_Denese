...
Friend Class CGroupListDatas
	...
	Private Sub Class_Initialize_Renamed()
		...
		m_CGroupListDatas = New Collection
	...
	Sub Add(ByRef Item As CGroupListData, Optional ByRef Key As Object = Nothing)
	...
	Function Item(ByRef Index As Object) As CGroupListData
		
		Item = m_CGroupListDatas.Item(Index)
	...
	'Function NewEnum() As stdole.IUnknown
		'
		'NewEnum = m_CGroupListDatas.GetEnumerator
		'
	'End Function
	...
	Function GetEnumerator() As System.Collections.IEnumerator Implements System.Collections.IEnumerable.GetEnumerator
		...
		'GetEnumerator = m_CGroupListDatas.GetEnumerator
	End Function
End Class